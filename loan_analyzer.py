...
print(f"The number of loans in the list are: {len(loan_costs)}")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
print(f"The total value of all the loans are: ${sum(loan_costs):,.2f}")
...
print(f"The remaining number of months in the loan are: {remaining_months}")
...
if present_value >= cost:
    print("yes, loan is worth at least the cost to buy it.")
else:
